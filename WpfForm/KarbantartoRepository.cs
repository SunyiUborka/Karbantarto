...
namespace WpfForm
{
    class KarbantartoRepository
    {
        ...
        public List<KarbantartasokList> SelectedItem(string szerelo, int cost = 5000)
        {
            ...
            if (selectedList.Count == 0) MessageBox.Show("Nincs ilyen szerelő!");
            return selectedList;
        }
        public void SaveFile(string path)
        {
            ...
            if (Directory.Exists(path))
            {
                ...
                if (!File.Exists(fileName))
                {
                    ...
                    MessageBoxResult result = MessageBox.Show("A fájl már létezik! Felül szeretnéd írni?", "Létező fájl!", MessageBoxButton.YesNo);
            ...
            {
                MessageBox.Show("Útvonal nem létezik!");
            }
        }
        ...
        public void AddKarbantartas(string MegNev, string SzerNev, int Time, DateTime Date)
        {
            ...
            else MessageBox.Show("Hibás adat!");
        }
    }
}